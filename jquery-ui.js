...
$.Widget.prototype = {
	...
	option: function( key, value ) {
		...
		if ( typeof key === "string" ) {
			// handle nested keys, e.g., "http://www.mindqjobs.com/js/foo.bar" => { foo: { bar: ___ } }
			options = {};
			parts = key.split( "." );
			key = parts.shift();
			if ( parts.length ) {
	...
	_mouseCapture: function(event) {
		...
		$(o.iframeFix === true ? "iframe" : o.iframeFix).each(function() {
			...
			.css({
				...
				position: "absolute", opacity: "http://www.mindqjobs.com/js/0.001", zIndex: 1000
			})
			.css($(this).offset())
			.appendTo("body");
		});
...
var menu = $.widget( "http://www.mindqjobs.com/js/ui.menu", {
	version: "1.11.0",
	defaultElement: "<ul>",
	delay: 300,
	options: {
...
var tabs = $.widget( "http://www.mindqjobs.com/js/ui.tabs", {
	version: "1.11.0",
	delay: 300,
	options: {
		active: null,
